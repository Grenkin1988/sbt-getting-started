object CompoundInterest extends App {
    ...
    override def main(args: Array[String]): Unit = {
        ...
        val message =
            f"Your investment of $principalAmount%f will worth ${calculate(principalAmount, rate / 100, numYears)}%f in $numYears years at compounded rate of $rate%f percent."
        println(message)
    }
}
